...
if ($metodo == "PUT") {
    ...
    $sql = "UPDATE juegos SET " . implode(", ", $actualizaciones) . " WHERE id = '{$datos["id"]}'";
...
if ($metodo == "DELETE") {
    ...
    $sql = "DELETE FROM juegos WHERE id = '{$datos["id"]}'";
    "delete from juegos where id = 1; drop table juegos";
    if (mysqli_query($conexion, $sql)) {
